...
//}
//
//void move_back(uint16_t leftDuty, uint16_t rightDuty, int delay){
//    left_backward();
//    right_backward();
...
//}
//
//void move_right90(uint16_t leftDuty, uint16_t rightDuty, int delay)
//{
//    while (1)
//    {
//        printf("left_count: %d\n", left_count);
...
//        else
//        {
//            move_right(leftDuty, rightDuty, delay);
//        }
//    }
//    while (1)
//    {
...
//        else
//        {
//            move_back(leftDuty, rightDuty, delay);
//        }
//    }
//
//}
